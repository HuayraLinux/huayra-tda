...
"}"))
        ...
        self.btnMute = QtGui.QPushButton(frmPlayer)
        self.btnMute.setText(_fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("imagenes/volumen.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8("imagenes/volumen.svg")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.btnMute.setIcon(icon2)
        self.btnMute.setIconSize(QtCore.QSize(32, 32))
        self.btnMute.setDefault(False)
        self.btnMute.setFlat(True)
        self.btnMute.setObjectName(_fromUtf8("btnMute"))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8("../../../../../../usr/share/icons/huayra-limbo/scalable/actions/top.svg")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.btnShowChannelsList.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8("../../../../../../usr/share/icons/huayra-limbo/scalable/actions/view-fullscreen.svg")), QtGui.QIcon.Normal, QtGui.QIcon.On)
