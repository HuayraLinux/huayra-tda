...
class MainFrame(wx.Frame):
    ...
    def OnScan(self, evt=None):
        ...
        self._scan_screen.SetIcon(wx.Icon(os.path.dirname(os.path.realpath(__file__))+"/icono-tda.png", wx.BITMAP_TYPE_PNG))
        self._scan_screen.Show()
    
    def OnAbout(self, evt=None):
        self._about_screen = AboutDialog(parent=self)
        self._about_screen.SetIcon(wx.Icon(os.path.dirname(os.path.realpath(__file__))+"/icono-tda.png", wx.BITMAP_TYPE_PNG))
